...
export default function Socials() {
    return (
        <>
            ...
            <div className="mt-10 mb-10 text-sm text-center dark:text-white">
                <Typewriter
            ...
            <div className="mt-10 text-2xl text-center dark:text-white">
                ...
                <div className="mt-2 flex flex-row justify-center space-x-6 align-middle dark:text-white">
